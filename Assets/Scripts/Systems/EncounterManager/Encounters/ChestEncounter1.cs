...
public class ChestEncounter1 : BaseEncounterFunctionality
{
     protected override void Effect1()
    {
        ...
        SceneData.instanceRef.mainText.text = "Opening the chest reveals some loot! Your party equips themselves appropriately.";
